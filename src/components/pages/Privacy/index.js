    ...
    <div className={classes.page}>
      <div className={classes.content}>
        ...
        <p>
          ...
          which include the App), we appreciate that you are trusting us with
        ...
        <ol>
          ...
          <li>
            <a href="#four">IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a>
          </li>
        ...
        <div id="two">
          ...
          <ul>
            ...
            <li>
              ...
              part of our efforts to keep our App safe and secure (for example,
        ...
        <div id="six">
          ...
          <p>
            ...
            and from our App is at your own risk. You should only access the App
