...
const PrivacyPage = ({ classes }) => {
  return (
    <div className={classes.page}>
      ...
      <p>
        Thank you for choosing to be part of our community at Pandemonium2020 ("
        ...
        please contact us at contact.macuyler@gmail.com.
      </p>
      <p>
        When you use our mobile application, as the case may be (the "<B>App</B>
        ") and more generally, use any of our services (the "<B>Services</B>",
        which include the App), we appreciate that you are trusting us with your
      ...
      <div id="two">
        ...
        <ul>
          ...
          <li>
            ...
            of our efforts to keep our App safe and secure (for example, for
          ...
          <li>
            <B>To respond to legal requests and prevent harm.</B> If we receive
            a subpoena or other legal request, we may need to inspect the data
      ...
      <div id="four">
        ...
        <p>
          ...
          <a href="#3">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a>" above),
      ...
      <div id="nine">
        ...
        <p>
          ...
          is not publicly displayed on the App, but please be aware that the
      ...
      <div id="eleven">
        ...
        <p>
          ...
          at contact.macuyler@gmail.com or fill out a report on our{' '}
